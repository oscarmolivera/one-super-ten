...
# dice = [true, true, true, true, true, true, false, true, true, true, true, true, true, true, false, true, true, true, true, true]
category_sample = [1,2,3,4,5]
tenant_schools.each do |school|
  2.times do |i|
    ...
    2.times do
      ...
      HTML
      tournament_start = Date.new(rand(2025..2026), rand(1..12), rand(1..28))
      tournament_days = [30, 60, 90]
